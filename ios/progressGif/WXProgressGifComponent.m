...
#import "WXProgressGifComponent.h"
//注册组件名称为progress
WX_PlUGIN_EXPORT_COMPONENT(progressGif, WXProgressGifComponent)


@implementation WXProgressGifComponent

    //组件暴露方法给前端，在前端用this.$refs.progress.log()调用，
